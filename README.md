...
There is a **vignette** written as a short introduction to the syntax of the main functions in this package. The vignette can be viewed either in R along with the regular R documentation by typing the command `?slouch`, or at [the package website](https://kopperud.github.io/slouch/articles/user-guide.html).
